 ...
 */
class DistutilsBuildSettingsWidget : public ProjectExplorer::BuildConfigWidget
{
    Q_OBJECT

public:
    explicit DistutilsBuildSettingsWidget(DistutilsTarget *target);
...
private:
    DistutilsTarget *m_target;
    Utils::PathChooser *m_pathChooser;
    QComboBox *m_toolChainChooser;
    DistutilsBuildConfiguration *m_buildConfiguration;
};

 ...
 */
class DistutilsProjectNode : public ProjectExplorer::ProjectNode
{
    Q_OBJECT

public:
    DistutilsProjectNode(DistutilsProject *project, Core::IDocument *projectFile);
...
private:
    ...
    // TODO: DistutilsProject calls the protected method addFileNodes() from DistutilsProjectNode.
    // Instead of this friend declaration, a public interface might be preferable.
    friend class DistutilsProject;
};

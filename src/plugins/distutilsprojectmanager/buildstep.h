...
public:
    ...
    DistutilsBuildConfiguration *distutilsBuildConfiguration() const;
    bool init();
...
protected:
    ...
    BuildStep(ProjectExplorer::BuildStepList *bsl, const QString &id);
...
public:
    MakeStepConfigWidget(BuildStep *makeStep);

...
//////////////////////////////////////
// DistutilsOpenProjectWizard class
//////////////////////////////////////
DistutilsOpenProjectWizard::DistutilsOpenProjectWizard(DistutilsManager *manager,
...
void DistutilsOpenProjectWizard::init()
{
    setOption(QWizard::NoBackButtonOnStartPage);
    setWindowTitle(tr("Distutils Wizard"));
}

DistutilsManager *DistutilsOpenProjectWizard::distutilsManager() const
{
    return m_manager;
}

QString DistutilsOpenProjectWizard::buildDirectory() const
{
    return m_buildDirectory;
}

QString DistutilsOpenProjectWizard::sourceDirectory() const
{
    return m_sourceDirectory;
}

void DistutilsOpenProjectWizard::setBuildDirectory(const QString &directory)
{
...
// BuildPathPage class
/////////////////////////
BuildPathPage::BuildPathPage(DistutilsOpenProjectWizard *wizard)
